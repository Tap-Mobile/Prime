...
open class PrimeLoggerImpl(val scope: CoroutineScope, appContext: Context) {
    ...
    private val logger = LoggerFactory.getLogger(PrimeLoggerImpl::class.java) as ch.qos.logback.classic.Logger
    ...
    fun getLogFiles(): List<File> {
        val logFile = File(PrimeLogger.logDir, PrimeLogger.fileName)
        val logFile2 = File(PrimeLogger.logDir, PrimeLogger.fileName2)
