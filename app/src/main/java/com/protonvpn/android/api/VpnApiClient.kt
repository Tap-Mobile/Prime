...
class VpnApiClient(
    ...
    override val appVersionHeader get() = "${Constants.CLIENT_ID}_" + BuildConfig.VERSION_NAME
    override val enableDebugLogging = BuildConfig.DEBUG
    //Need to setup DohApiHandler before using it
    override val shouldUseDoh get() = false /*userData.apiUseDoH && !vpnStateMonitor.isConnected*/

    override val userAgent: String
        get() = String.format(
            Locale.US, "ProtonVPN/%s (Android %s; %s %s)",
