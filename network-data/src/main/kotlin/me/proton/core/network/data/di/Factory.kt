...
class ApiFactory(
    ...
    fun <Api : BaseRetrofitApi> create(
        ...
        val securityStrategy = { builder: OkHttpClient.Builder ->
        }
        ...
        val alternativeSecurityStrategy = { builder: OkHttpClient.Builder ->
        }
...
/*        RefreshTokenHandler<Api>(
        ...
        ProtonForceUpdateHandler<Api>(apiClient),
